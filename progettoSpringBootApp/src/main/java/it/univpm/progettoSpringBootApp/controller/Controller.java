...
public class Controller {
	...
	/**
     * Percorso che la farmacia con lo specifico codice.
     * @return void
     */
	@RequestMapping(value = "/dati", method = RequestMethod.DELETE)
	  public void deleteFarmaciaSimple(@RequestParam(name="codiceFarmacia")String codiceFarmacia)
	  {
	    servizio.deleteFarmaciaSimple(codiceFarmacia);
	  }

	/**
     * Percorso che elimina tutte le farmacie
